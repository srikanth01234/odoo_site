      ...
      <main>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto text-center mb-20 px-4">
            <h2 className="text-4xl font-bold text-zinc-950 mb-4 uppercase tracking-tight">Order Management</h2>
            <div className="w-20 h-1.5 bg-red-600 mx-auto mb-6"></div>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
              Streamline your kitchen operations with a unified order management system that tracks every ticket from placement to delivery.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center px-6 mb-24">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-zinc-950 leading-tight">
                Swift Order Handling, <br/> Happier Diners.
              </h2>
              
              <p className="text-lg text-zinc-600 leading-relaxed">
                Connect your front-of-house with the kitchen seamlessly. Every order is automatically routed, prioritized, and tracked, reducing errors and ensuring that every dish arrives at the table exactly as intended.
              </p>
        ...
        <section className="bg-zinc-950 py-24 px-6 text-white overflow-hidden relative">
           ...
           <div className="max-w-7xl mx-auto text-center relative z-10">
             <h2 className="text-3xl md:text-5xl font-bold mb-8">Ready to Optimize Your Kitchen?</h2>
             <p className="text-zinc-400 text-lg mb-10 max-w-2xl mx-auto">
               Join hundreds of restaurants that use Dine360 to manage their orders with 
               speed and precision.
             </p>
