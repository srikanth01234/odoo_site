        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col gap-6 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mt-1">
              <Link
                href="/contact"
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-7 py-3.5 rounded-xl font-semibold text-base transition-all shadow-lg shadow-emerald-600/20 active:scale-95"
              >
                Start Free Now
              </Link>
              <Link
                href="/contact"
                className="border-2 border-zinc-200 hover:border-emerald-500 text-zinc-700 hover:text-emerald-600 px-7 py-3.5 rounded-xl font-semibold text-base transition-all active:scale-95"
              >
                Book A Demo
              </Link>
            </div>
          ...
          <div className="relative h-[500px] w-full flex items-center justify-center lg:justify-end" style={{ perspective: '1000px' }}>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] bg-gradient-to-tr from-emerald-50/50 to-green-50/50 rounded-full blur-3xl -z-10" />
            ...
            <div className="relative w-full h-full max-w-md mx-auto lg:mr-0">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 h-2/5 bg-gradient-to-t from-zinc-900/90 via-zinc-900/40 to-transparent p-4 flex flex-col justify-end">
                  ...
                  <div className="absolute bottom-0 left-0 w-full h-16 text-green-500/90">
                    <svg viewBox="0 0 1440 320" preserveAspectRatio="none" className="w-full h-full">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden bg-zinc-50/50 rounded-[3rem]">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            ...
            <span className="text-emerald-600 font-bold tracking-widest uppercase text-xs">Dine Better, Earn More</span>
            <div className="h-[1px] w-8 bg-emerald-500" />
          </motion.div>
          ...
          >
            ...
            <span className="text-emerald-600">Menumium Has You Covered</span>
          </motion.h2>
        ...
        <div className="relative flex justify-center items-center min-h-[600px]">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl h-full -z-10">
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute top-10 left-1/4 w-[500px] h-[500px] bg-emerald-100/50 rounded-[4rem] -rotate-12"
            />
            <motion.div
              initial={{ opacity: 0, rotate: 15, scale: 0.8 }}
              whileInView={{ opacity: 1, rotate: 5, scale: 1 }}
          ...
          <div className="relative z-10 w-full max-w-4xl flex justify-center">
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col pt-8">
                <div className="w-12 h-12 rounded-2xl bg-emerald-500 mb-4 mx-auto flex items-center justify-center text-white font-bold text-xl">M</div>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            <div className="h-[1px] w-8 bg-emerald-500" />
            <span className="text-emerald-400 font-bold tracking-widest uppercase text-xs">All-in-One Full Service Solution</span>
            <div className="h-[1px] w-8 bg-emerald-500" />
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-6 order-2 lg:order-1">
            <div className="flex items-center gap-3">
              <div className="h-[2px] w-10 bg-emerald-500 relative">
                <div className="absolute -right-1 -top-1 w-2 h-2 bg-emerald-500 rounded-full" />
              </div>
              <span className="text-emerald-500 font-bold tracking-wider uppercase text-xs flex items-center gap-2">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex gap-3 items-start group">
                  <div className="mt-1 flex-shrink-0 w-5 h-5 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
            ...
            <div className="pt-4">
              <Link href="/contact" className="inline-flex items-center bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3.5 rounded-xl font-bold text-base transition-all shadow-lg shadow-emerald-600/20 active:scale-95">
                Get Started Now
              </Link>
            </div>
          </div>
              ...
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex gap-1.5 text-[9px] font-bold">
                    ...
                    <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full">Served</span>
                  </div>
                </div>
                <div className="flex-1 space-y-3">
                  {[
                    ...
                    <div key={i} className="p-3.5 bg-zinc-50 rounded-2xl border border-zinc-100 flex items-center justify-between">
                      ...
                      <div className={`w-1.5 h-1.5 rounded-full ${order.status === 'Served' ? 'bg-green-400' : order.status === 'Preparing' ? 'bg-emerald-400' : 'bg-yellow-400'}`} />
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="relative h-[420px] w-full">
            ...
            >
              <div className="grid grid-cols-4 gap-3 h-full">
                {[...Array(8)].map((_, i) => (
                  <div key={i} className={`aspect-square rounded-xl flex flex-col items-center justify-center border transition-all ${i % 3 === 0 ? 'border-emerald-500 bg-emerald-50 text-emerald-600' : i % 3 === 1 ? 'border-yellow-300 bg-yellow-50 text-yellow-600' : 'border-zinc-100 bg-zinc-50 text-zinc-300'}`}>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <button className="w-full h-7 bg-emerald-600 text-white rounded text-[9px] font-bold">Confirm Booking</button>
              </div>
            </motion.div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div key={i} className="flex gap-3 p-2.5 bg-white border border-zinc-100 rounded-xl shadow-sm">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          ...
                          <span className="text-emerald-500 text-[9px] font-bold">Premium</span>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            >
              <div className="p-4">
                ...
                <label className="flex items-center gap-2 text-[9px] text-zinc-800 font-bold mb-3">
                  <input type="radio" name="pay" defaultChecked className="accent-emerald-500" /> Card / Contactless
                </label>
                <div className="flex gap-2">
                  <button className="flex-1 h-8 border border-zinc-100 rounded-lg text-[9px] font-bold">Split</button>
                  <button className="flex-2 h-8 bg-emerald-600 rounded-lg text-[9px] text-white font-bold px-3">Charge</button>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-emerald-500 font-bold tracking-wider uppercase text-xs">POS</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 leading-tight">
                  ...
                  <div className="space-y-2">
                    {['Wagyu Tenderloin — $68', 'Seared Foie Gras — $38', 'Truffle Risotto — $42'].map((item, i) => (
                      <div key={i} className="flex justify-between items-center p-2 border border-zinc-50 rounded-lg">
                        ...
                        <span className="text-[10px] text-emerald-600 font-bold">{item.split('—')[1]}</span>
                      </div>
                    ))}
                  </div>
                </div>
                <div className="p-3 border-t border-zinc-100">
                  <div className="w-full py-2 bg-emerald-600 text-white rounded-lg text-center text-[10px] font-bold">View Full Menu</div>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            >
              <div className="flex flex-col h-full gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] px-2 py-0.5 bg-emerald-100 text-emerald-600 rounded-full font-bold">3 Active</span>
                </div>
                {[
                  { title: 'Chef\'s Tasting Menu — 15% Off', desc: 'Sunday Evening — Limited Covers', badge: 'TASTING', color: 'bg-emerald-50 border-emerald-100' },
