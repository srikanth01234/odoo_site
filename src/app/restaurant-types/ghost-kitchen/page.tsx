    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden bg-zinc-50/50 rounded-[3rem]">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            ...
            <span className="text-red-600 font-bold tracking-widest uppercase text-xs">Deliver Smarter, Scale Faster</span>
            <div className="h-[1px] w-8 bg-red-500" />
          </motion.div>
          ...
          >
            ...
            <span className="text-red-600">Menumium Powers Your Virtual Kitchen</span>
          </motion.h2>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            <div className="h-[1px] w-8 bg-red-500" />
            <span className="text-red-400 font-bold tracking-widest uppercase text-xs">All-in-One Ghost Kitchen Solution</span>
            <div className="h-[1px] w-8 bg-red-500" />
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto bg-white">
        <div className="text-center mb-16">
          ...
          >
            The orangeprint for a <br /> High-Performing Ghost Kitchen
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center justify-between">
                  <h3 className="font-bold text-zinc-900 text-sm flex items-center gap-2">
                    <Package className="w-4 h-4 text-red-500" /> Stock Overview
                  </h3>
                  ...
                  {[
                    ...
                    <div key={i} className="p-3 bg-zinc-50 rounded-xl border border-zinc-100">
                      ...
                      <div className="w-full h-1.5 bg-zinc-200 rounded-full overflow-hidden">
                        <div className={`h-full rounded-full ${item.level < 40 ? 'bg-red-400' : 'bg-red-500'}`} style={{ width: `${item.level}%` }} />
                      </div>
                    </div>
                  ))}
                </div>
            ...
            >
              <div className="p-4">
                ...
                <label className="flex items-center gap-2 text-[9px] text-zinc-800 font-bold mb-3">
                  <input type="radio" name="pay" defaultChecked className="accent-red-500" /> Online / COD
                </label>
                <div className="flex gap-2">
                  <button className="flex-1 h-8 border border-zinc-100 rounded-lg text-[9px] font-bold">Clear</button>
                  <button className="flex-2 h-8 bg-red-600 rounded-lg text-[9px] text-white font-bold px-3">Confirm Order</button>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="relative h-[420px] w-full order-1 lg:order-2">
            ...
            >
              <h3 className="font-bold text-zinc-900 text-sm flex items-center gap-2 mb-4">
                <BookOpen className="w-4 h-4 text-red-500" /> Brand Menus
              </h3>
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div className="p-3.5 bg-red-50 rounded-2xl border border-red-100">
                  <p className="text-[9px] text-red-400 font-bold uppercase mb-0.5">Menus</p>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <Dot className="text-red-400 w-6 h-6 animate-pulse" />
              </div>
          ...
          <div className="relative h-[420px] w-full">
            ...
            >
              <div className="flex flex-col h-full gap-4">
                ...
                {[
                  { title: 'Free Delivery on Orders $30+', desc: 'All Brands — Weekend Special', badge: 'FREE', color: 'bg-red-50 border-red-100' },
                  { title: 'Combo Deal 25% Off', desc: 'BurgerBrand — Weekday Lunch', badge: 'COMBO', color: 'bg-yellow-50 border-yellow-100' },
                  { title: 'Loyalty Points x2', desc: 'After 3 Orders — All Brands', badge: 'LOYALTY', color: 'bg-orange-50 border-orange-100' }
                ].map((promo, i) => (
